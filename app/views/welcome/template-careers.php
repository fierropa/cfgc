...
<div class="content-wrap">
	<div class="container">
        ...
        <?php 
          $args = array('orderby' => 'date', 'order' => 'DESC', 'category_name' => 'employment-opportunity-listing', 'meta_key' => 'location'); 
          $q = new WP_Query($args);
          // $posts = $q->posts;
        ?>
                      ...
                      <tbody>
                        <?php if ( $q->have_posts() ) : ?>
                          ...
                          <?php while ( $q->have_posts() ) : $q->the_post(); ?>
                            <tr data-job-location="" data-job-title="<?php echo $q->post->post_title ?>" data-job-type="">
