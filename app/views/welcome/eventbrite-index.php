...
<div role="main" id="content" class="content-wrap">
  ...
  <section id="events-header" class="top-level-section-heading">
    <div class="row narrow quote-as-title">
      <div class="col-twelve">
        <div class="top-level-section-title">
          <h3 class="animate-this impact-header">Events</h3>
        </div>
      </div>
    </div>
  </section>
	...
	<div class="container">
		...
		<div id="primary" class="content-area col-md-12">
			<main id="main" class="site-main" role="main" data-template="eventbrite-events-page-index">
