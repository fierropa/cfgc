...
class nusoap_base {
	...
	* @access	public
	*/
	function nusoap_base_constructor() {
...
class nusoap_fault extends nusoap_base {
	...
	*/
	function nusoap_fault_constructor($faultcode,$faultactor='',$faultstring='',$faultdetail=''){
		parent::nusoap_base_constructor();
...
class nusoap_xmlschema extends nusoap_base  {
	...
	* @access   public
	*/
	function nusoap_xmlschema_constructor($schema='',$xml='',$namespaces=array()){
		parent::nusoap_base_constructor();
...
class soapval extends nusoap_base {
	...
	* @access   public
	*/
  	function soapval_constructor($name='soapval',$type=false,$value=-1,$element_ns=false,$type_ns=false,$attributes=false) {
		parent::nusoap_base_constructor();
		$this->name = $name;
		$this->type = $type;
		$this->value = $value;
...
class nusoap_server extends nusoap_base {
	...
	* @access   public
	*/
	function nusoap_server_constructor($wsdl=false){
		parent::nusoap_base_constructor();
		// turn on debugging?
		global $debug;
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl_constructor($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=30,$curl_options=null,$use_curl=false){
		parent::nusoap_base_constructor();
...
class nusoap_parser extends nusoap_base {
	...
	* @access   public
	*/
	function nusoap_parser_constructor($xml,$encoding='UTF-8',$method='',$decode_utf8=true){
		parent::nusoap_base_constructor();
		$this->xml = $xml;
